...
const sendPasswordResetEmail = async (email, token)=>{
    try {
        const resetLink = `${("TURBOPACK compile-time value", "http://localhost:3000") || 'http://localhost:3000'}/reset-password?token=${token}`;
        const mailOptions = {
            from: '"Wyldcard Stats Private Limited" <noreply@wildcardstat.com>',
            to: email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ccb1ec8c._.js.map