...
"[project]/apps/web/src/models/User.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/models/User.ts [app-route] (ecmascript)");
;
;
;
;
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
                const user = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                ...
                if ([
                    ...
                    throw new Error('Staff accounts must login through the Admin Control Center.');
                }
                return {
...
"[project]/apps/web/src/models/Event.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/models/Ticket.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/app/api/events/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/bcryptjs/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/models/Event.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$Ticket$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/models/Ticket.ts [app-route] (ecmascript)");
    ...
    try {
        ...
        if (session.user.role === 'SUPER_ADMIN') {
            ...
            if (vmDetails) {
                ...
                if (mode === 'create') {
                    let user = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                        email
                    });
                    if (user) {
                        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ...
                    user = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                        name,
                        email,
                        password: hashedPassword,
                        role: 'VENUE_MANAGER'
                    });
                    const { sendWelcomeEmail } = await __turbopack_context__.A("[project]/apps/web/src/lib/email.ts [app-route] (ecmascript, async loader)");
                    await sendWelcomeEmail(email, name, 'VENUE_MANAGER', generatedPassword);
                    venueManagerId = user._id;
                } else if (mode === 'existing') {
                    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        ...
        const event = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(eventData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: event
        }, {
...
async function GET(req) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const events = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            isActive: true
        }).sort({
            startDate: 1
        }).lean();
        const eventsWithStats = await Promise.all(events.map(async (event)=>{
            const soldCount = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$models$2f$Ticket$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                event: event._id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8773c72a._.js.map