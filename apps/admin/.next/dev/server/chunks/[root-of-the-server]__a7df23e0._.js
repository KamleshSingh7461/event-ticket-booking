...
"[project]/apps/admin/src/lib/email.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const sendPasswordResetEmail = async (email, token)=>{
    try {
        const resetLink = `${("TURBOPACK compile-time value", "http://localhost:3001") || 'http://localhost:3000'}/reset-password?token=${token}`;
        const mailOptions = {
            from: '"Wyldcard Stats Private Limited" <noreply@wildcardstat.com>',
            to: email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7df23e0._.js.map