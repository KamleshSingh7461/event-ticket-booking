...
"[project]/apps/admin/src/app/api/venue-manager/coordinators/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        if (existingUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const coordinator = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
            email,
...
async function GET(req) {
    try {
        ...
        const coordinators = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            role: 'COORDINATOR',
...
async function DELETE(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            _id: id,
            role: 'COORDINATOR',
            createdBy: session.user.id
        });
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Coordinator not found or unauthorized'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd244f8b._.js.map