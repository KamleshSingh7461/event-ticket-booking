...
"[project]/apps/admin/src/app/api/venue-manager/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const activeCoordinators = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            role: 'COORDINATOR',
        ...
        const eventStats = await Promise.all(events.map(async (event)=>{
            const tickets = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$Ticket$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
                event: event._id,
            ...
            tickets.forEach((ticket)=>{
                if (ticket.selectedDates && Array.isArray(ticket.selectedDates)) {
                    ticket.selectedDates.forEach((date)=>{
            ...
            // Peak Day
            const peakDay = Object.entries(dailyBreakdown).reduce((max, [date, count])=>count > max.count ? {
                    date,
                    count
                } : max, {
                date: '',
        ...
        const upcomingEvents = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            venueManager: session.user.id,
            startDate: {
                $gte: new Date()
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88e6be92._.js.map