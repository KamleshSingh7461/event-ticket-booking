...
"[project]/apps/admin/src/models/Invoice.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
InvoiceSchema.pre('save', async function(next) {
    if (!this.invoiceNumber) {
        const count = await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('Invoice').countDocuments();
...
"[project]/apps/admin/src/app/api/admin/invoices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/admin/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$Invoice$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/admin/src/models/Invoice.ts [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        ...
        // Fetch all invoices
            ...
            const myEvents = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        ...
        const invoices = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$models$2f$Invoice$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
            createdAt: -1
        }).populate('event', 'title').populate('user', 'name email');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: invoices
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f3fba2b._.js.map