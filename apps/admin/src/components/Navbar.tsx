        ...
        <nav className="border-b bg-[#AE8638] text-black sticky top-0 z-50 shadow-md">
            <div className="container flex h-16 items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <a href={`${process.env.NEXT_PUBLIC_WEB_URL || 'http://localhost:3000'}/events`} className="text-sm font-bold text-black hover:text-white transition-colors">
                        Events
                    </a>
                    <a href={`${process.env.NEXT_PUBLIC_WEB_URL || 'http://localhost:3000'}/about`} className="text-sm font-bold text-black hover:text-white transition-colors">
                        About
                    </a>
            ...
            {isMenuOpen && (
                <div className="md:hidden border-t bg-[#AE8638] p-4 space-y-4 shadow-xl">
                    <div className="flex flex-col space-y-3">
                        <a href={`${process.env.NEXT_PUBLIC_WEB_URL || 'http://localhost:3000'}/events`} className="text-sm font-bold text-black hover:text-white transition-colors" onClick={toggleMenu}>
                            Events
                        </a>
                        <a href={`${process.env.NEXT_PUBLIC_WEB_URL || 'http://localhost:3000'}/about`} className="text-sm font-bold text-black hover:text-white transition-colors" onClick={toggleMenu}>
                            About
                        </a>
                    </div>
